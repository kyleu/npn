...
##
## Outputs:
##   - build/dist/npn_<version>_android_aar.zip
##   - build/dist/npn_<version>_android_apk.zip
...
GOARCH=arm64 time gomobile bind -o build/dist/mobile_android_arm64/npn.aar -target=android -androidapi 21 github.com/kyleu/npn/app/cmd
echo "gomobile for Android completed successfully, building distribution..."
cd "build/dist/mobile_android_arm64"
zip -r "../npn_${TGT}_android_aar.zip" .
...
rm -rf ./app/libs
mkdir -p ./app/libs
cp ../mobile_android_arm64/npn.aar ./app/libs/
cp ../mobile_android_arm64/npn-sources.jar ./app/libs/

gradle assembleDebug
cd app/build/outputs/apk/debug
zip -r "$dir/../../build/dist/npn_${TGT}_android_apk.zip" .

echo "Output written to [./build/dist/npn_${TGT}_android_aar.zip] and [./build/dist/npn_${TGT}_android_apk.zip]"
