...
func (r *Raw) Merge(data util.ValueMap, logger util.Logger) Config {
	return &Raw{
		Type:    util.MergeLog("body.raw.type", r.Type, data, logger),
		Content: util.MergeLog("body.raw.content", r.Content, data, logger),
		Length:  r.Length,
		Binary:  r.Binary,
	}
}
