...
type Config interface {
	...
	MimeType() string
	String() string
	Merge(data util.ValueMap, logger util.Logger) Config
	Clone() *Body
}
...
func (b *Body) Merge(data util.ValueMap, logger util.Logger) *Body {
	if b == nil || b.Type == "" {
		return nil
	}
	cfg := b.Config
	...
	return &Body{
		Type:   util.MergeLog("body.type", b.Type, data, logger),
		Length: b.Length,
		Config: cfg,
	}
}
