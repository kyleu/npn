...
func (l *Large) Merge(data util.ValueMap, logger util.Logger) Config {
	return &Large{
		Filename:    util.MergeLog("body.large.filename", l.Filename, data, logger),
		ContentType: util.MergeLog("body.large.content.type", l.ContentType, data, logger),
		Length:      l.Length,
	}
}
