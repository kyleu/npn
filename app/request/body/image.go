...
func (r *Image) Merge(data util.ValueMap, logger util.Logger) Config {
	return &Image{
		Type:    util.MergeLog("body.image.type", r.Type, data, logger),
		Content: util.MergeLog("body.image.content", r.Content, data, logger),
	}
}
