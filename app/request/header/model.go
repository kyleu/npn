...
func (h Header) Merge(data util.ValueMap, logger util.Logger) *Header {
	return &Header{
		Key:         util.MergeLog("header."+h.Key+".key", h.Key, data, logger),
		Value:       util.MergeLog("header."+h.Key+".value", h.Value, data, logger),
		Description: util.MergeLog("header."+h.Key+".description", h.Description, data, logger),
	}
}
...
func (h Headers) Merge(data util.ValueMap, logger util.Logger) Headers {
